...
<div id="{{ $id }}" class="dropzone" data-init-function="bpFieldInitDropzoneElement"
    data-config='@json($field['config'] ?? [], JSON_FORCE_OBJECT)' data-allow-multiple='@json(!!$field['allow_multiple'])'>
    <input @if (!empty($field['value'])) data-value='@json($field['value'])' @endif type="hidden"
        data-name="{{ $field['name'] }}" style="position:absolute; height: 1px; width: 1px; opacity: 0;" />
