...
<div class="custom-control custom-switch">
    <input type="checkbox" class="custom-control-input" id="switch_{{ $id }}" {{ $is_active ? 'checked' : '' }}
...
<script>
    if (typeof window.toggleActive === 'undefined') {
        window.toggleActive = function(id, status) {
