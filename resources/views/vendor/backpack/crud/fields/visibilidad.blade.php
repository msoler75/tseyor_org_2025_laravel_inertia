...
@include('crud::fields.inc.wrapper_start')
    ...
    <option value="B"{{ $field['value'] === 'B' ? ' selected' : '' }}>Borrador</option>
    <option value="P"{{ $field['value'] === 'P' ? ' selected' : '' }}>Publicado</option>
</select>
-->
...
@push('crud_fields_styles')
    ...
    @basset('visibilidadFieldStyle.css')

    {{-- How to add some CSS? --}}
    @bassetBlock('backpack/crud/fields/visibilidad_field-style.css')
        <style>
            .visibilidad_field_class {
                display: none;
            }
        </style>
    @endBassetBlock
...
@push('crud_fields_scripts')
    ...
    @basset('visibilidadFieldScript.js')
