...
<x-backpack::menu-dropdown title="Comunicación" icon="la la-comments">
    ...
    <x-backpack::menu-dropdown-item title="Correos" icon="la la-envelope" :link="backpack_url('correos-enviados')" />
...
<x-backpack::menu-dropdown title="Avanzado" icon="la la-cog">
    ...
    <x-backpack::menu-dropdown-item title="Aviso Mantenimiento" icon="la la-tools" :link="backpack_url('aviso-mantenimiento/edit')" />
