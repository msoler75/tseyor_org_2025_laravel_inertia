<template>
    <nav
        ...
        :class="[
            portada ? (nav.scrollY<200?'bg-base-100/0':'bg-base-100 shadow-sm') :
            nav.fullPage ? 'bg-base-200/20 hover:bg-base-200/100 transition duration-200' : 'bg-base-100 border-b',
