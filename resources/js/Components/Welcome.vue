...
<template>
    <div>
        <div class="p-6 lg:p-8 bg-base-100 dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
