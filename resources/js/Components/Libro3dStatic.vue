<template>
    <Link :href="route('libro', libro.slug)" class="shrink-0 w-fit h-fit">
    <div class="book-container w-fit mx-auto" :class="cargando?'is-loading':''">
        <Image :src="libro.imagen" class="rounded-xs rounded-tl-lg border-t border-l border-gray-500 border-opacity-15" :class="imageClass" @loaded="cargando=false"/>
    </div>
    </Link>
</template>
