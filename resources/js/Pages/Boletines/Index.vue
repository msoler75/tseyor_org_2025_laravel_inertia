    ...
    <Page>
        ...
        <div class="flex justify-between items-center mb-20">
            ...
            <div class="flex gap-2">
                <Share />
                <AdminLinks modelo="boletin" necesita="administrar contenidos" />
            </div>
        </div>
        ...
        <ContentMain class="flex justify-end mb-5">
            <SearchInput placeholder="Buscar en boletines..."/>
        </ContentMain>

        <div class="w-full flex gap-7 lg:gap-10 flex-wrap md:flex-nowrap">

            <Categorias :categorias="categorias" parametro="tipo" :url="route('boletines')" :resultados="filtrado?'Resultados':false" />
            ...
            <div class="w-full grow card shadow-2xs bg-base-100 px-5 py-7">
                ...
                <GridAppear class="grid gap-2 py-4" col-width="24rem" :time-lapse="0.01">
                    <Link v-for="contenido in listado.data" :key="contenido.id"
                        :href="route('boletin', contenido.id)"
                    ...
                    <div class="w-full">
                        <div v-html="contenido.titulo" class="font-bold" />
