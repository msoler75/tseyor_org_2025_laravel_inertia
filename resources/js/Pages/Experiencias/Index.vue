<template>
    <Page>
        ...
        <div class="w-full flex gap-7 lg:gap-10 flex-wrap md:flex-nowrap">
            ...
            <div
                class="gap-3 xl:gap-0 w-full md:w-[30ch] card bg-base-100 shadow-2xs flex-wrap flex-row xl:flex-col p-5 lg:p-10 xl:p-5 self-baseline md:sticky md:top-20">
            ...
            <div class="cloud w-full grow card shadow-2xs bg-base-100 px-5 py-7">
