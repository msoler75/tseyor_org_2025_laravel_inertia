        ...
        <Section>
            ...
            src-height="543">
                <div class="text-base lg:text-lg xl:text-xl xl:leading-8 space-y-4">
                    ...
                    <div>Hemos mantenido contacto <b>por más de 40 años</b> con seres humanos vivos de diversos planetas de la
                        galaxia.</div>
                </div>
            </Hero>
        </Section>
            ...
            src-height="383">
                <div class="text-base lg:text-lg xl:text-xl xl:leading-8 space-y-4">
                    ...
                    <div><b>Melinus</b> aprovechó durante unas sesiones de practicantes de hipnosis para <b>comunicarse
                            telepáticamente</b> e invitó a los presentes a iniciar una ronda de conversaciones amistosas.
                    </div>
                </div>
            </Hero>
        </Section>
        ...
        <Section>
            ...
            src-height="544">
                <div class="text-base lg:text-lg xl:text-xl xl:leading-8 space-y-4">
                    ...
                    <div>(Con el tiempo nuestro amigo recibiría la formación necesaria para ser hoy día el canal de comunicación
        ...
        <Section>
            ...
            >
                <div class="text-base lg:text-lg xl:text-xl xl:leading-8 space-y-4">
                    ...
                    <div>También se les presentaría a <b>Olión</b>, de Ganímedes, cuyos bisabuelos son de origen terrestre.</div>
                </div>
                </Hero>
        </Section>
            ...
            src-height="673">
                <div class="text-base lg:text-lg xl:text-xl xl:leading-8 space-y-4">
                    <div>Tras superar varias vicisitudes, en el año 2001 la <b>Confederación</b> hizo una llamada telepática a
                        ...
                        <div>Le citaron para que acudiera a la mágica montaña de <b>Montserrat</b>, en la noche, a una hora y un lugar
            ...
            src-height="317"
                ...
                <div class="text-base lg:text-lg xl:text-xl xl:leading-8 space-y-4">
                    <div>Dentro del coche, esperando el momento, <b>Marisa</b> recibió un mensaje telepático de <b>Olión</b>, para
                        ...
                        <div>A la hora acordada <b>una gran nave</b> apareció a pocos metros de distancia, ligera como una pluma. Esto
            ...
            src-height="817">
                <div class="text-base lg:text-lg xl:text-xl xl:leading-8 space-y-4">
                    <div>A continuación la Confederación propuso a ambos seguir adelante y formar parte de <b>un proyecto de
                        ...
                        <div>A su vez, <b>Marisa</b> recibió el nombre de <b>Sala</b> y ha sido y es un apoyo indispensable para
                            todos.</div>
                        </div>
            </Hero>
        </Section>
            ...
            src-height="815">
                <div class="text-base lg:text-lg xl:text-xl xl:leading-8 space-y-4">
                    <div>Junto a nuevos miembros del grupo crearon la asociación sin ánimo de lucro <b>Tseyor Centro de Estudios
                        ...
                        <div>Años más tarde se unieron muchas más personas y se creó la <b>Universidad Tseyor de Granada</b>, y
            ...
            src-height="896">
                <div class="text-base lg:text-lg xl:text-xl xl:leading-8 space-y-4">
                    ...
                    <div>Hay muchas más historias que contar, pero que no cabrían en esta presentación, así que si te interesa las
                        puedes conocer en nuestra web.</div>
                    </div>
            </Hero>
        </Section>
