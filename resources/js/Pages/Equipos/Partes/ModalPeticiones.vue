<template>
    <Modal :show="modalPeticiones" maxWidth="sm" @close="modalPeticiones = false">
        <div class="bg-base-200 p-5 flex flex-col gap-5 max-h-[90vh] select-none">
            <h3>Peticiones de ingreso</h3>
            ...
            <div class="py-3 flex justify-between sm:justify-end gap-5">
                <button @click.prevent="modalPeticiones = false" type="button" class="btn btn-neutral">
                    cerrar
                </button>
            </div>
        </div>
...
const modalPeticiones = ref(false)
