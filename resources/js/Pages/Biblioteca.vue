    ...
    <div class="container py-12 mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-14">
                <div>
                    <p>La Biblioteca Tseyor es el resultado de más de 1500 diálogos <Referencia r="telepatía">
                            telepáticos</Referencia> con seres de la <Referencia>Confederación de Mundos Habitados de la
                ...
                <div class="flex gap-5">
                    <p class="">Todos los materiales han sido publicados y están preservados por la <Referencia>
                            Universidad Tseyor de Granada</Referencia> para mantener la integridad del mensaje original
                        y sus obras impresas están registradas por la asociación <Referencia>TSEYOR Centro de Estudios
        ...
        <GridAppear class="grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="flex justify-end gap-4 items-center opacity-50 group-hover:opacity-100 mt-auto">
                <span :class="seccion.count ? 'opacity-50' : 'opacity-0'">{{ seccion.count }} {{ seccion.collection?seccion.collection:seccion.title.toLowerCase() }}</span>
