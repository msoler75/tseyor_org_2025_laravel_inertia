    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <TextText :srcImage="centro.imagen" cover full>
            <template #text1>
                 ...
                 <Carousel :per-page="1" autoplay autoplayTimeout="4000" autoplayHoverPause :loop="true" paginationActiveColor="#0088ff" paginationColor="gray">
            ...
            <template #text2>
                ...
                <div v-if="centro.contacto" class="flex justify-end mt-12">
                    <Link :href="route('contacto', centro.contacto?.slug)" class="btn btn-primary">Ver Ficha de Contacto
                    </Link>
                </div>
            </Card>
        </template>
        ...
        <div v-if="entradas.length" class="mt-20">
            ...
            <GridAppear col-width="24rem" class="gap-4">
                <CardContent v-for="entrada in entradas" :key="entrada.slug" image-left
                    :title="entrada.titulo"             :image="entrada.imagen"
                    :href="route('entrada', entrada.slug)"
