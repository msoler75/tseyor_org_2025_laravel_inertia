    ...
    <div>
        ...
        <div v-if="tokens.length > 0">
            ...
            <div class="mt-10 sm:mt-0">
                <ActionSection>
                    ...
                    <template #content>
                        <div class="space-y-6">
                            <div v-for="token in tokens" :key="token.id" class="card bg-base-100">
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div v-if="$page.props.jetstream.flash.token" class="mt-4 bg-gray-100 dark:bg-gray-900 px-4 py-2 rounded-xs font-mono text-sm text-gray-500 break-all">
