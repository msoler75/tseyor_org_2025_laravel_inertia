    ...
    <Sections white-first>
        ...
        <Section :height="screen&&screen.width<768?'400px':'550px'">
            <TextImage title="Universidad Tseyor de Granada"
                ...
                <blockquote>
                    <p>
                        La Universidad Tseyor de Granada mantendrá comunicación,
                        información e interrelación con los distintos Muulasterios en todo el
                        mundo, las casas Tseyor y los pueblos Tseyor también. Y será una fuente
                        en la que todo Muul podrá acceder de pleno derecho.
                    </p>
                </blockquote>
            </TextImage>
        </Section>
        ...
        <Section class="pb-10">
            ...
            <div class="container mx-auto text-right">
                <p>Shilcars, Comunicado interdimensional 429</p>
            </div>
        </Section>
                ...
                <GridFill w="24rem">
                    <div v-for="departamento of departamentos" :key="departamento.nombre" class="flex gap-3 items-start">
                        ...
                        <div class="flex flex-col gap-4">
                            <Link :href="route('utg.departamento', departamento.slug)" class="font-bold text-lg">{{ departamento.nombre }}</Link>
