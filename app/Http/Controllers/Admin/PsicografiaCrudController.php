...
class PsicografiaCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field([   // select_from_array
            ...
            'options'     => ['General' => 'General', 'Palabras Maya'=>'Palabras Maya', 'Neent' => 'Neent', 'Equipos y Departamentos'=>'Equipos y Departamentos','FractalOm' => 'FractalOm', 'Muulasterios y Casas Tseyor' => 'Muulasterios y Casas Tseyor', 'Priores y Belankiles' => 'Priores y Belankiles', 'Contacto con las bases' => 'Contacto con las bases', 'Eventos' => 'Eventos'],
            'allows_null' => false,
            'default'     => 'General',
