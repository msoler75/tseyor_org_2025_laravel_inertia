...
/**
 * MyCustomTool - MCP Tool Implementation
 *
 * QUICK START GUIDE:
 * ==================
 ...
 * 6. Test with: php artisan mcp:test-tool MyCustomTool
 *
 * QUICK START GUIDE:
 * ==================
 * 1. Update the name() method with your tool's unique identifier
...
class MyCustomTool implements ToolInterface
{
    ...
    {
        return 'Description of MyCustomTool - explain what this tool does and its purpose. Replace with specific details about functionality, inputs, outputs, and use cases.';
    }
