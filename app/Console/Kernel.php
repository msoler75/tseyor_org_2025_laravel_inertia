    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        */
        ...
        $schedule->command('db:backup')
            ...
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Database Backup');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Database Backup');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Database Backup');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Database Backup');
            });
        ...
        $schedule->command('sitemap:generate')
            ...
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Sitemap Generate');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Sitemap Generate');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Sitemap Generate');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Sitemap Generate');
            });
        ...
        $schedule->command('check-bounced notificaciones --hours=26')
            ...
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Check Bounced Emails');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Check Bounced Emails');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Check Bounced Emails');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Check Bounced Emails');
            });
        ...
        $schedule->exec("DEPLOY_USER={$deployUser} ".base_path('bash/boletin_preparar.sh')." {$boletinToken} mensual")
            ...
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Boletín Mensual');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Boletín Mensual');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Boletín Mensual');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Boletín Mensual');
            });
        ...
        $schedule->exec("DEPLOY_USER={$deployUser} ".base_path('bash/boletin_preparar.sh')." {$boletinToken} quincenal")
            ...
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Boletín Quincenal Día 1');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Boletín Quincenal Día 1');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Boletín Quincenal Día 1');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Boletín Quincenal Día 1');
            });
        ...
        $schedule->exec("DEPLOY_USER={$deployUser} ".base_path('bash/boletin_preparar.sh')." {$boletinToken} quincenal")
            ...
            ->appendOutputTo(storage_path('logs/boletin-quincenal.log'))
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Boletín Quincenal Día 15');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Boletín Quincenal Día 15');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Boletín Quincenal Día 15');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Boletín Quincenal Día 15');
            });
        ...
        $schedule->exec("DEPLOY_USER={$deployUser} ".base_path('bash/boletin_preparar.sh')." {$boletinToken} semanal")
            ...
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Boletín Semanal');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Boletín Semanal');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Boletín Semanal');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Boletín Semanal');
            });
        ...
        $schedule->exec("DEPLOY_USER={$deployUser} ".base_path('bash/boletin_enviar_pendientes.sh')." {$boletinToken}")
            ...
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Enviar Boletines Pendientes');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Enviar Boletines Pendientes');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Enviar Boletines Pendientes');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Enviar Boletines Pendientes');
            });
        ...
        $schedule->command('inscripciones:gestionar')
            ...
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Gestionar Inscripciones');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Gestionar Inscripciones');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Gestionar Inscripciones');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Gestionar Inscripciones');
            });
        ...
        $schedule->exec("DEPLOY_USER={$deployUser} ".base_path('bash/check_system_load.sh'))
            ...
            ->before(function () {
                Log::channel('jobs')->info('Iniciando tarea: Check System Load');
            })
            ->after(function () {
                Log::channel('jobs')->info('Completada tarea: Check System Load');
            })
            ->onFailure(function () {
                Log::channel('jobs')->error('Falló tarea: Check System Load');
            })
            ->onSuccess(function () {
                Log::channel('jobs')->info('Éxito en tarea: Check System Load');
            });
